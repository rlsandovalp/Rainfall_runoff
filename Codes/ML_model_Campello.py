...
train_variables = [['Lesmo', '8120_1', [0+anticipation,1+anticipation]],
                  ...
                  ['Nibionno', '5882_4', precipitation_list]]
...
np.savetxt('../Results/coefficients_campello_'+str(anticipation)+'hr.txt', svr_lin.coef_)
np.savetxt('../Results/intercept_campello_'+str(anticipation)+'hr.txt', svr_lin.intercept_)
